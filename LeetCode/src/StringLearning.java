...
public class StringLearning {
    ...
    static class Solution {
        ...
        public int myAtoi(String s) {
            char[] chars = s.toCharArray();
            int idx = 0, min = Integer.MIN_VALUE, max = Integer.MAX_VALUE;
            boolean flag = false;
            long res = 0;
            ...
            while (idx < chars.length && chars[idx] <= '9' && chars[idx] >= '0') {
        ...
        public int strStr1(String haystack, String needle) {
            ...
            while (idx < haystack.length()) {
                if (pos == -1 || haystack.charAt(idx) == needle.charAt(pos)) {
                    idx++;
                    pos++;
        ...
        public String countAndSay(int n) {
            return getCountAndSay(n, "1", 1);
        }

        private String getCountAndSay(int n, String str, int depth) {
            if (depth == n)
                return str;
            StringBuilder sb = new StringBuilder();
            int left = 0, right = 1;
            while (right <= str.length()) {
                if (right < str.length() && str.charAt(left) == str.charAt(right)) {
                    ...
                    sb.append(String.valueOf(right - left)).append(str.charAt(left));
                    left = right;
                    right++;
                }
            }
            return getCountAndSay(n, sb.toString(), depth + 1);
        }
